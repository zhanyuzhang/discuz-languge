...
$lang = array (
	...
	'you_have_friends'			=> 'You are friends already',//'你们已经是好友了',
	...
	'send_result_succeed'			=> 'Mail has been sent, your friend will receive after some minutes',//'邮件已经送出，您的好友可能需要几分钟后才能收到邮件',
	...
	'logout_succeed'		=> 'Logged out successfully, now redirecting to the previous page as guest... {ucsynlogout} ',//'您已退出站点，现在将以游客身份转入退出前页面…… {ucsynlogout} ',
...
/*3.2*/	'mobile_template_no_found'	=> 'You have visited the page without a mobile phone. Would you like to further access to the PC version?<br /><br /><a href="{url}">Continue access</a><br /><br />',//'您访问的页面无手机页面，是否进一步访问电脑版？<br /><br /><a href="{url}">继续访问</a><br /><br />',
	...
	'thread_rate_banned'		=> 'Sorry, you can not rate banned posts.',//'对不起，您不能对屏蔽帖评分，请返回。',
	...
	'invite_code_endtime_error'	=> 'Sorry, your invitation url has been expired.',//'对不起，您访问的邀请链接已经失效。',
	...
	'comment_edit_noexist'			=> 'The comment that you are editing to does not exist.',//'要编辑的评论不存在',
	'comment_delete_noexist'		=> 'The comment that you are deleting to does not exist.',//'要删除的评论不存在',
